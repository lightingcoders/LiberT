        ...
        if ($offer = $offers->first()) {
            ...
            try {
                ...
                DB::transaction(function () use (&$trade) {
                    $trade = Auth::user()->trades()
                        ->save($trade);

                    $trade->generateAddress();
                });
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($offers)
                ...
                ->editColumn('status', function ($data) {
                    if ($data->status) {
                        return "<span class='btn btn-icon round disabled btn-sm btn-success'><i class='ft-power'></i></span>";
                    } else {
                        return "<span class='btn btn-icon round disabled btn-sm btn-danger'><i class='ft-power'></i></span>";
                    }
                })
