(function (window, document, $) {
    ...
    var menuWrapper = $('div[data-menu="menu-wrapper"]'),
        menuWrapper_el = menuWrapper.html(),
        menuWrapperClasses = menuWrapper.attr('class');
    ...
    $.app.menu = {
        ...
        manualScroller: {
            ...
            init: function () {
                var scroll_theme = (mainMenu.hasClass('menu-dark')) ? 'light' : 'dark';

                this.obj = mainMenuContent.perfectScrollbar({
            ...
            update: function () {
                if (this.obj) {
                    ...
                    if ($('.main-menu').data('scroll-to-active') === true) {
                        var position;
                        if (mainMenuContent.find('li.active').parents('li').length > 0) {
                            position = mainMenuContent.find('li.active').parents('li').last().position();
                        }
                        else {
                            position = mainMenuContent.find('li.active').position();
                        }
                        setTimeout(function () {
                            ...
                            mainMenu.data('scroll-to-active', 'false');
                        }, 300);
                    }
                    mainMenuContent.perfectScrollbar('update');
                }
            },
            ...
            disable: function () {
                if (this.obj) {
                    mainMenuContent.perfectScrollbar('destroy');
                }
            },
        ...
        init: function (compactMenu) {
            if (mainMenuContent.length > 0) {
                this.container = mainMenuContent;
        ...
        drillDownMenu: function (screenSize) {
            var  drilldownMenu = $('.drilldown-menu')
            if (drilldownMenu.length) {
                if (screenSize === 'sm' || screenSize === 'xs') {
                    if ($('#navbar-mobile').attr('aria-expanded') === 'true') {
                        drilldownMenu.slidingMenu({
                            backLabel: true
                        });
                    }
                }
        ...
        change: function (defMenu) {
            ...
            if (headerNavbar.hasClass('navbar-brand-center')) {
                headerNavbar.attr('data-nav', 'brand-center');
            }
        ...
        transit: function (callback1, callback2) {
            var menuObj = this;
            var mainMenuHeader = $('.main-menu-header');
        ...
        open: function () {
            this.transit(function () {
                ...
                if (!mainMenu.hasClass('menu-native-scroll') && mainMenu.hasClass('menu-fixed')) {
                    this.manualScroller.enable();

                    mainMenuContent.css('height', $(window).height() - $('.header-navbar').height() - $('.main-menu-header').outerHeight() - $('.main-menu-footer').outerHeight());
        ...
        expand: function () {
            if (this.expanded === false) {
                ...
                this.transit(function () {
                    ...
                    if ((mainMenu.hasClass('menu-native-scroll') || $body.data('menu') === 'horizontal-menu')) {
                    ...
                    if (($body.data('menu') === 'vertical-menu' || $body.data('menu') === 'vertical-menu-modern') && mainMenu.hasClass('menu-fixed')) {
                        $('.main-menu-content').css('height', $(window).height() - $('.header-navbar').height() - $('.main-menu-header').outerHeight() - $('.main-menu-footer').outerHeight());
                        // this.manualScroller.update();
                    }
    ...
    $.app.nav = {
        ...
        initialized: false,
        navItem: navigationMain.find('li').not('.navigation-category'),
        ...
        bind_events: function () {
            ...
            navigationMain.on('mouseenter.app.menu', 'li', function () {
                var $this = $(this);
                ...
                if (($body.hasClass('menu-collapsed') && $body.data('menu') !== 'vertical-menu-modern') || ($body.data('menu') === 'vertical-compact-menu' && !$body.hasClass('vertical-overlay-menu'))) {
                    mainMenuContent.children('span.menu-title').remove();
                    mainMenuContent.children('a.menu-title').remove();
                    mainMenuContent.children('ul.menu-content').remove();
                ...
                if ($listItem.is('.disabled')) {
                    ...
                    if (
                        ($body.hasClass('menu-collapsed') && $body.data('menu') !== 'vertical-menu-modern') ||
                        ($body.data('menu') === 'vertical-compact-menu' && $listItem.is('.has-sub') && !$body.hasClass('vertical-overlay-menu'))
                    ) {
                        e.preventDefault();
                    }
                    else {
