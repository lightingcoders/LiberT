(function (window, document, $) {
    ...
    $(window).on('load', function () {
        ...
        function setContentMenuHeight() {
            ...
            var bodyHeight = contentBody.height();

            if (bodyHeight < menuHeight) {
                contentBody.css('height', menuHeight);
            }
        }
        ...
        if (scrollableContainer.length > 0) {
            scrollableContainer.perfectScrollbar({
                theme: "dark"
            });
        }
        ...
        var currenctUrl = window.location.href.split('#')[0];
                ...
                case 'prompt-ajax':
                    swal({
                        ...
                        content: {
                            element: "input",
                            attributes: {
                                placeholder: button.data('promptPlaceholder') ?
                                    button.data('promptPlaceholder'): "Comment...",
                                type: 'text'
                            },
                        },
                        closeOnClickOutside: false,
