    ...
    <div class="card-content">
        <div class="card-body">
            ...
            <div class="card-footer text-right">
                <a @click="resetOfferTag()" data-toggle="modal"
                   data-target="#offer-tag-form" class="btn btn-outline-primary">
                    {{__('NEW OFFER TAG')}}
                </a>
            </div>
...
<div class="modal fade text-left" id="offer-tag-form" tabindex="-1" role="dialog" aria-labelledby="offer-tag-form-label"
    ...
    <div class="modal-dialog" role="document">
        {!! Form::open(['url' => route('moderation.offer_settings.store-offer-tags'), 'class' => 'form form-horizontal', 'method' => 'POST']) !!}
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title" id="offer-tag-form-label">
                    <i class="la la-send"></i> {{__('New Offer Tag')}}
                </h4>
