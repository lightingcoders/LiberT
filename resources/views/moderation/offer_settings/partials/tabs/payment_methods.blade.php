    ...
    <div class="card-content">
        <div class="card-body">
            ...
            <div class="card-footer text-right">
                <a @click="resetPaymentMethodCategory()" data-toggle="modal"
                   data-target="#payment-method-category-form" class="btn btn-outline-primary">
                    {{__('NEW CATEGORY')}}
                </a>
            </div>
...
<div class="modal fade text-left" id="payment-method-category-form" tabindex="-1" role="dialog" aria-labelledby="payment-method-category-form-label"
    ...
    <div class="modal-dialog" role="document">
        {!! Form::open(['url' => route('moderation.offer_settings.store-payment-method-categories'), 'class' => 'form form-horizontal', 'method' => 'POST']) !!}
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title" id="payment-method-category-form-label">
                    <i class="la la-send"></i> {{__('New Category')}}
                </h4>
            ...
            <div class="modal-body">
                <div class="form-body">
                    {!! Form::hidden('id', null, ['v-model' => 'form.paymentMethodCategory.id']) !!}

                    <div class="form-group row">
                        <label class="col-md-4">{{__('Name')}}</label>
                        <div class="col-md-8">
                            {!! Form::text('name', null, ['class' => 'form-control', 'v-model' => 'form.paymentMethodCategory.name', 'placeholder' => __('Enter a category name...')]) !!}
                        </div>
                    </div>
...
<div class="card border-top-blue-grey">
    <div class="card-head">
        <div class="card-header">
    ...
    <div class="card-content">
        ...
        <div class="card-footer text-right">
            <a @click="resetPaymentMethod()" data-toggle="modal"
               data-target="#payment-method-form" class="btn btn-outline-primary">
                {{__('NEW METHOD')}}
            </a>
        </div>
    </div>
...
<div class="modal fade text-left" id="payment-method-form" tabindex="-1" role="dialog" aria-labelledby="payment-method-form-label"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        {!! Form::open(['url' => route('moderation.offer_settings.store-payment-methods'), 'class' => 'form form-horizontal', 'method' => 'POST']) !!}
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title" id="payment-method-form-label">
                    <i class="la la-send"></i> {{__('New Method')}}
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <div class="form-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('category', $payment_method_category, null, ['class' => 'form-control', 'is' => 'select2', 'v-model' => 'form.paymentMethod.category', 'placeholder' => __('Select a category...')]) !!}
                        </div>
                    </div>
