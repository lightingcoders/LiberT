...
@section('page.body')
                        ...
                        <div class="card-body cc BTC pb-1">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <h4 class="text-white">
                                        {{$wallet['btc']['total_available']}} BTC
                                    </h4>
                                </div>
                                <div class="col-6 text-right">
                                    <h3 class="text-white mb-2 font-large-1">
                                        {{$wallet['btc']['total_available_price']}}
                                    </h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-content">
                        <div class="card-body cc DASH pb-1">
                            <div class="row">
                                <div class="col-6">
                                    <h4 class="text-white mb-3">
                                        <i class="cc DASH" title="DOGE"></i> Dash
                                    </h4>
                                    <h6 class="text-white mb-1">
                                        Balance
                                    </h6>
                                    <h4 class="text-white">
                                        {{$wallet['dash']['total_available']}} DASH
                                    </h4>
                                </div>
                                <div class="col-6 text-right">
                                    <h3 class="text-white mb-2 font-large-1">
                                        {{$wallet['dash']['total_available_price']}}
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body cc LTC pb-1">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <h4 class="text-white">
                                        {{$wallet['ltc']['total_available']}} LTC
                                    </h4>
                                </div>
                                <div class="col-6 text-right">
                                    <h3 class="text-white mb-2 font-large-1">
                                        {{$wallet['ltc']['total_available_price']}}
                                    </h3>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-right">
                        <a href="{{route('marketplace.create-offer.sell')}}" class="btn btn-success">
                            {{__('CREATE OFFER')}}
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="earning-chart position-relative">
                            <div class="chart-title position-absolute mt-2 ml-2">
                                <h1 class="display-4">{{number_format($successful_trades_count)}}</h1>
                                <span class="text-muted">{{__('Successful Trades')}}</span>
                            </div>
                ...
                // My Offers
                {
                    ...
                    'options': {
                        ...
                        columns: [
                            ...
                            {data: 'type'},
                            {data: 'currency'},
                            {data: 'amount_range', orderable: false},
                            {data: 'profit_margin'},
                            {data: 'payment_method'},
    ...
    @push('mixins')
        <script type="text/javascript">
            window.tradesChart = {!! json_encode([
                'total' => $successful_trades_data['total'],
                'month' => $successful_trades_data['month'],
            ]) !!}

            window._vueData = {!! json_encode([
                'ratings_endpoint' => route('ajax.profile.get-ratings', ['user' => Auth::user()->name]),
...
@push('mixins')
    <script src="{{asset('js/pages/home/mixin.js')}}" type="text/javascript"></script>
@endpush

@push('scripts')
    <script src="{{asset('js/pages/home/script.js')}}" type="text/javascript"></script>
@endpush
