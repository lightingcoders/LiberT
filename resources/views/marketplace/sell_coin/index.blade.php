        ...
        <div class="content-header-left col-12 mb-2">
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    {{ Breadcrumbs::render('marketplace.sell_coin') }}
                </div>
            </div>
        </div>
    </div>
            ...
            window._tableData = [
                // Sell Offers
                {
                    ...
                    'options': {
                        "ajax": {
                            "async": true,
                            "url": '{{route('marketplace.sell-coin.data')}}',
                            "type": "POST",
                            "data": {
...
@push('mixins')
    <script src="{{asset('js/pages/marketplace/sell_coin/mixin.js')}}" type="text/javascript"></script>
@endpush

@push('scripts')
    <script src="{{asset('js/pages/marketplace/sell_coin/script.js')}}" type="text/javascript"></script>
@endpush
