    ...
    <div class="content-header row">
        <div class="content-header-left col-8 mb-2">
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    {{ Breadcrumbs::render('marketplace.create_offer.buy') }}
                </div>
            </div>
        </div>
        ...
        <div class="content-header-right col-4">
            <div class="btn-group float-right">
                <a href="{{route('marketplace.create-offer.sell')}}" class="btn btn-danger round box-shadow-2 px-2">
        ...
        <div class="col-lg-10 offset-lg-1">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        {!! Form::open(['url' => route('marketplace.create-offer.store', ['type' => 'buy']), 'class' => 'form form-horizontal']) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="bs-callout-primary callout-border-left mt-1 p-1">
                                        ...
                                        <p class="card-text">
                                            ...
                                            <b>@{{ formatAmount(totalPrice) }}</b> {{__('per')}}
                                            <b>@{{ coins[coin] }}</b>.
                                        </p>
