    ...
    <div class="content-header row">
        <div class="content-header-left col-8 mb-2">
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    {{ Breadcrumbs::render('marketplace.create_offer.sell') }}
                </div>
            </div>
        </div>
        ...
        <div class="content-header-right col-4">
            <div class="btn-group float-right">
                <a href="{{route('marketplace.create-offer.buy')}}" class="btn btn-success round box-shadow-2 px-2">
            ...
            <div class="card">
                <div class="card-header text-center border-top-red">
                    ...
                    <h6>
                        ...
                        <a href="{{route('marketplace.create-offer.buy')}}">
                            {{__('Create Buy Offer')}}
                        </a>
                    </h6>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        {!! Form::open(['url' => route('marketplace.create-offer.store', ['type' => 'sell']), 'class' => 'form form-horizontal']) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="form-section"><i class="la la-dollar"></i> {{__('Select Wallet')}} </h4>
                                ...
                                <div class="col-md-6">
                                    <h4 class="form-section"><i class="la la-money"></i> {{__('Payment Method')}}
                                    </h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="form-section"><i class="ft-percent"></i> {{__('Profit Margin')}}</h4>
                                    ...
                                    <div class="bs-callout-primary callout-border-left mt-1 p-1">
                                        ...
                                        <p class="card-text">
                                            {{__('Current market price is')}} <b>@{{ formatAmount(coinPrice) }}</b>.
                                            <br/>
                                            {{__('I am selling for')}}
                                ...
                                <div class="col-md-6">
                                    <h4 class="form-section"><i class="ft-briefcase"></i> {{__('Amount Range')}}</h4>
                                    <div class="form-group row">
                                        <div class="col-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h4 class="form-section"><i class="ft-info"></i> {{__('Terms & Instruction')}}</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="form-section"><i class="ft-check"></i> {{__('Requirements')}}</h4>
...
@push('mixins')
    <script src="{{asset('js/pages/marketplace/create_offer/mixin.js')}}" type="text/javascript"></script>
@endpush

@push('scripts')
    <script src="{{asset('js/pages/marketplace/create_offer/script.js')}}" type="text/javascript"></script>
@endpush
