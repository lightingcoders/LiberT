        ...
        <div class="content-header-left col-12 mb-2">
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    {{ Breadcrumbs::render('marketplace.buy_coin') }}
                </div>
            </div>
        </div>
    </div>
            ...
            window._tableData = [
                // Buy Offers
                {
                    ...
                    'options': {
                        "ajax": {
                            "async": true,
                            "url": '{{route('marketplace.buy-coin.data')}}',
                            "type": "POST",
                            "data": {
...
@push('mixins')
    <script src="{{asset('js/pages/marketplace/buy_coin/mixin.js')}}" type="text/javascript"></script>
@endpush

@push('scripts')
    <script src="{{asset('js/pages/marketplace/buy_coin/script.js')}}" type="text/javascript"></script>
@endpush
