                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="contacts-list" class="table table-white-space table-borderless table-striped row-grouping display no-wrap icheck table-middle">
                                        <thead>
                                        <tr>
                                            <th></th>
...
@push('scripts')
    <script type="text/javascript">
        function reloadContactsTable(){
            Page.reloadDataTable('#contacts-list')
        }
    </script>
@endpush
