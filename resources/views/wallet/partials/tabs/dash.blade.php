            ...
            <div class="row">
                <div class="col-6">
                    <h4 class="text-white mb-3">
                        <i class="cc DOGE" title="DOGE"></i> Dash
                    </h4>
                ...
                <div class="col-6 text-right">
                    <h3 class="text-white mb-2 font-large-1">{{$wallet['dash']['total_available_price']}}</h3>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="tab-content px-1 pt-1">
                <div role="tabpanel" class="tab-pane active" id="dash-address"
                    ...
                    @if(isset($wallet['dash']['latest_address']))
                        <div class="row">
                            <div class="col-sm-6 py-1 text-center">
                                {!! HTML::image($wallet['dash']['latest_address_qr_code'], null, ['class' => 'img-thumbnail']) !!}
                            </div>
                            <div class="col-sm-6 py-4 text-center">
                                ...
                                <div class="card-text text-center pt-1">
                                    <h2><b>{{$wallet['dash']['latest_address']}}</b></h2>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="send-dash-label">
                                                    <i class="la la-send"></i> {{__('Send')}} Dash</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-body">
                                                    <h3 class="text-center">{{__('Available:')}} {{$wallet['dash']['total_available']}}
                                                        DOGE</h3>
                                                    <hr>
                                                    <div class="form-group row">
                                                        <label class="col-md-4">{{__('Amount')}}</label>
                                                        <div class="col-md-8">
                                                            {!! Form::text('amount', null, ['class' => 'form-control', 'v-model.number' => 'send.dash_value', 'placeholder' => $wallet['dash']['total_available'], 'novalidate']) !!}
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-success" :disabled="!send.dash_value || send.dash_value > balance.dash_value">
                                                    {{__('Send')}}
                                                </button>
                                            </div>
                                        </div>
