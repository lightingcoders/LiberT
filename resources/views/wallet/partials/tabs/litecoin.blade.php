        ...
        <div class="card-body  bg-secondary cc LTC pb-1">
            <div class="row">
                ...
                <div class="col-6 text-right">
                    <h3 class="text-white mb-2 font-large-1">{{$wallet['ltc']['total_available_price']}}</h3>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="tab-content px-1 pt-1">
                <div role="tabpanel" class="tab-pane active" id="litecoin-address"
                    ...
                    @if(isset($wallet['ltc']['latest_address']))
                        <div class="row">
                            <div class="col-sm-6 py-1 text-center">
                                {!! HTML::image($wallet['ltc']['latest_address_qr_code'], null, ['class' => 'img-thumbnail']) !!}
                            </div>
                            <div class="col-sm-6 py-4 text-center">
                                ...
                                <div class="card-text text-center pt-1">
                                    <h2><b>{{$wallet['ltc']['latest_address']}}</b></h2>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-body">
                                                    <h3 class="text-center">{{__('Available:')}} {{$wallet['ltc']['total_available']}}
                                                        LTC</h3>
                                                    <hr>
                                                    <div class="form-group row">
                                                        <label class="col-md-4">{{__('Amount')}}</label>
                                                        <div class="col-md-8">
                                                            {!! Form::text('amount', null, ['class' => 'form-control', 'v-model.number' => 'send.ltc_value', 'placeholder' => $wallet['ltc']['total_available'], 'novalidate']) !!}
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-success" :disabled="!send.ltc_value || send.ltc_value > balance.ltc_value">
                                                    {{__('Send')}}
                                                </button>
                                            </div>
                                        </div>
