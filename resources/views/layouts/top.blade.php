<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-hide-on-scrol navbar-without-dd-arrow fixed-top navbar-semi-light bg-info navbar-shadow">
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content" id="navbar">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-language nav-item">
                        <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false" id="dropdown-flag">
                            <i class="flag-icon flag-icon-gb"></i>
                            <span class="selected-language"></span>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-gb"></i> {{__('English')}}
                            </a>
                            {{--<a class="dropdown-item" href="#"><i class="flag-icon flag-icon-fr"></i> {{__('French')}}--}}
                            {{--</a>--}}
                            {{--<a class="dropdown-item" href="#"><i class="flag-icon flag-icon-cn"></i> {{__('Chinese')}}--}}
                            {{--</a>--}}
                            {{--<a class="dropdown-item" href="#"><i class="flag-icon flag-icon-de"></i> {{__('German')}}--}}
                            {{--</a>--}}
                        </div>
                    </li>
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label animated infinite" @click="hideBellAlert()"
                           :class="bellAnimation" data-toggle="dropdown" href="#">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="dropdown-menu-footer">
                                <a class="dropdown-item text-muted text-center"
                                   href="{{route('profile.notifications.index', ['user' => Auth::user()->name])}}">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label animated infinite" @click="hideMailAlert()"
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="media-heading">
                                                @{{message.user.name}}  <small>(@{{message.trade.token}})</small>
                                            </h6>
                                            ...
                                            <p class="notification-text font-small-3 text-muted" v-else>
                                                {{__('File:')}} <b>@{{truncate(message.content.replace(/^.*[\\\/]/, ''), 8)}}</b>
                                            </p>
                                            <small>
