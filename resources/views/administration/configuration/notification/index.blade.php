...
@section('page.name', __('Notification Configuration'))
@section('page.body')
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">{{__('Notification Configuration')}}</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    {{ Breadcrumbs::render('administration.configuration.notification') }}
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in show" id="general"
                            ...
                            @include('administration.configuration.notification.partials.tabs.general')
                        </div>
                        <div class="tab-pane fade" id="user-activated" role="tabpanel"
                             aria-labelledby="user-activated-tab" aria-expanded="false">
                            @include('administration.configuration.notification.partials.tabs.template', [
...
@push('mixins')
    <script src="{{asset('js/pages/administration/configuration/notification/mixin.js')}}" type="text/javascript"></script>
@endpush

@push('scripts')
    <script src="{{asset('js/pages/administration/configuration/notification/script.js')}}" type="text/javascript"></script>
@endpush
