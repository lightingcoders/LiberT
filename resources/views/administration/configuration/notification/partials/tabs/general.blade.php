    ...
    <div class="card-content">
        <div class="card-body">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" id="settings-tab" data-toggle="tab" aria-controls="settings"
                       href="#settings" aria-expanded="true">{{__('Settings')}}</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content px-1 pt-1">
                <div role="tabpanel" class="tab-pane active" id="settings" aria-expanded="true" aria-labelledby="settings-tab">
                    <div class="card-text">
                        <p>
                    ...
                    {!! Form::open(['url' => route('administration.configuration.notification.update-general'), 'class' => 'form form-horizontal', 'method' => 'POST']) !!}
                    <div class="form-body">
                        <h4 class="form-section"><i class="ft-mail"></i> {{__('EMAIL')}}</h4>
                        <div class="form-group row">
                            {!! Form::label('MAIL_DRIVER', 'Driver', ['class' => 'col-md-3']) !!}
                            <div class="col-md-9">
                                {!! Form::select('MAIL_DRIVER', get_mail_drivers(), $env['MAIL_DRIVER']['value'], ['is' => 'select2', 'class' => 'form-control', 'v-model' => 'form.settings.mail_driver']) !!}
                            </div>
                        </div>
                        ...
                        <div v-if="form.settings.mail_driver == 'mailgun'">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('MAILGUN_DOMAIN', $env['MAILGUN_DOMAIN']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('MAILGUN_SECRET', $env['MAILGUN_SECRET']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="form.settings.mail_driver == 'ses'">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('SES_KEY', $env['SES_KEY']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('SES_SECRET', $env['SES_SECRET']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('SES_REGION', $env['SES_REGION']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="form.settings.mail_driver == 'sparkpost'">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('SPARKPOST_SECRET', $env['SPARKPOST_SECRET']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('MAIL_HOST', $env['MAIL_HOST']['value'], ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('MAIL_PORT', $env['MAIL_PORT']['value'], ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('MAIL_USERNAME', $env['MAIL_USERNAME']['value'], ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('MAIL_PASSWORD', $env['MAIL_PASSWORD']['value'], ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('MAIL_ENCRYPTION', $env['MAIL_ENCRYPTION']['value'], ['class' => 'form-control']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('SMS_PROVIDER', get_sms_providers(), $env['SMS_PROVIDER']['value'], ['is' => 'select2', 'class' => 'form-control', 'v-model' => 'form.settings.sms_provider']) !!}
                            </div>
                        </div>
                        ...
                        <div v-if="form.settings.sms_provider == 'nexmo'">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('NEXMO_KEY', $env['NEXMO_KEY']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('NEXMO_SECRET', $env['NEXMO_SECRET']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('NEXMO_PHONE', $env['NEXMO_PHONE']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="form.settings.sms_provider == 'africastalking'">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('AFRICASTALKING_USERNAME', $env['AFRICASTALKING_USERNAME']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('AFRICASTALKING_KEY', $env['AFRICASTALKING_KEY']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('AFRICASTALKING_FROM', $env['AFRICASTALKING_FROM']['value'], ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="component" aria-labelledby="component-tab">
                    {!! Form::open(['url' => route('administration.configuration.notification.update-component'), 'class' => 'form form-horizontal', 'method' => 'POST']) !!}
                    <div class="form-body">
