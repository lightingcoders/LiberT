                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        @if($data = $content['app'])
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="info-text"> {{__("Setup your application details..")}} </h4>
                                </div>
                            </div>
                        ...
                        @if($data = $content['db'])
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="info-text"> {{__("Setup your database connection..")}} </h4>
                                </div>
                            </div>
                        ...
                        @if($data = $content['broadcast'])
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="info-text">{{__("Setup your application broadcast server..")}}</h4>
                                </div>
                            </div>
                        ...
                        @if($data = $content['mail'])
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="info-text"> {{__("Setup your application mail server..")}} </h4>
                                </div>
                            </div>
                        ...
                        @if($data = $content['extras'])
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="info-text"> {{__("We need some extra information..")}} </h4>
                                </div>
                            </div>
